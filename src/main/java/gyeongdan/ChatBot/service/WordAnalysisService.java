...
public class WordAnalysisService {
    ...
    public WordAnalysisService() {
        ...
        System.out.println(this.getClass().getName() + ".WordAnalysisService creator Start !");
        ...
        System.out.println("난 톰켓이 부팅되면서 스프링 프렝미워크가 자동 실행되었고, 스프링 실행될 때 nlp 변수에 Komoran 객체를 생성하여 저장하였다.");

        System.out.println(this.getClass().getName() + ".WordAnalysisService creator End !");
    ...
    public List<String> doWordNouns(String text) throws Exception {
        ...
        System.out.println(this.getClass().getName() + ".doWordAnalysis Start !");
        System.out.println("분석할 문장 : " + text);

        //분석할 문장에 대해 정제(쓸데없는 특수문자 제거)
        String replace_text = text.replace("[^가-힣a-zA-Z0-9", " ");
        System.out.println("한국어, 영어, 숫자 제외 단어 모두 한 칸으로 변환시킨 문장 : " + replace_text);

        //분석할 문장의 앞, 뒤에 존재할 수 있는 필요없는 공백 제거
        String trim_text = replace_text.trim();
        System.out.println("분석할 문장 앞, 뒤에 존재할 수 있는 필요 없는 공백 제거 : " + trim_text);
        ...
        while (it.hasNext()) {
            ...
            System.out.println("word : " + CmmUtil.nvl(word));
        }


        System.out.println(this.getClass().getName() + ".doWordAnalysis End !");
    ...
    public Map<String, Integer> doWordCount(List<String> pList) throws Exception {
        ...
        System.out.println(this.getClass().getName() + ".doWordCount Start !");
        ...
        System.out.println(this.getClass().getName() + ".doWordCount End !");
        return rMap;
    }
